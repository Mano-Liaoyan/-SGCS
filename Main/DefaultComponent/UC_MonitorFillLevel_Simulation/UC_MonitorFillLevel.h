...
//!	Generated Date	: Sun, 16, Jul 2023  
	File Path	: DefaultComponent\UC_MonitorFillLevel_Simulation\UC_MonitorFillLevel.h
*********************************************************************/
...
public :
    ...
    //## auto_generated
    const int getTempLevel(void) const;
    
    //## auto_generated
    void setTempLevel(const int p_tempLevel);
...
private :
    ...
    int tempLevel;		//## attribute tempLevel
